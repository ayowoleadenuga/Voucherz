...
class GiftBTextFields extends React.Component {
  state = {
    vData: {
      campaignName: "",
      amount: "",
        ...
        <form className={classes.container} noValidate autoComplete="off">
          <Grid md={12}>
            ...
            <TextField
              ...
              helperText="Please input the Gift voucher amount"
...
GiftBTextFields.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(GiftBTextFields);
