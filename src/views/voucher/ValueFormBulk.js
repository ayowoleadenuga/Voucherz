...
class ValueBTextFields extends React.Component {
  state = {
    vData: {
      campaignName: "",
      amount: "",
        ...
        <form className={classes.container} noValidate autoComplete="off">
          <Grid md={12}>
            ...
            <TextField
              ...
              helperText="Please input the voucher attached amount"
            ...
            <TextField
              ...
              helperText="Please input the Gift voucher quantity"
              onChange={this.handleChange}
              type="number"
              className={classes.textField}
              InputLabelProps={{
...
ValueBTextFields.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(ValueBTextFields);
